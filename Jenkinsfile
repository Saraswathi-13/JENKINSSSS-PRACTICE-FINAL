    ...
    stages {
        ...
        stage('Deploy Frontend to Tomcat') {
            steps {
                ...
                xcopy /E /I /Y frontend\\dist\\* "C:\\Program Files\\Apache Software Foundation\\Tomcat 10.1\\webapps\\reacthospitalapi"
                '''
            }
        }
        ...
        stage('Deploy Backend to Tomcat') {
            steps {
                ...
                copy "SpringBootBackend\\target\\*.war" "C:\\Program Files\\Apache Software Foundation\\Tomcat 10.1\\webapps\\springboothospitalapi"
                '''
            }
        }
